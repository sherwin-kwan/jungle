...
describe User, type: :model do
  ...
  describe "Registration (is_guest = false)" do
    ...
    it "fails to create if password is missing" do
      user = User.create(name: "Abraham Lincoln", given_name: "Abe", email: "abc@abc.com", password: nil,
                         is_guest: false)
      expect(user.persisted?).to be(false)
    end
  end
  ...
  describe "Emails" do
    ...
    it "fails if email is not entered in the right format" do
      user = User.create(name: "Abraham Lincoln", given_name: "Abe", email: "this.is.an.email.notreally",
  ...
  describe "Passwords" do
    ...
    it "fails if password is shorter than 5 characters" do
      user = User.create(name: "Abraham Lincoln", given_name: "Abe", email: "abc@abc.com", password: "abcd",
                         password_confirmation: "abcd", is_guest: false)
      expect(user.persisted?).to be(false)
    end

    it "passes if password is 5 or more characters" do
      user = User.create(name: "Abraham Lincoln", given_name: "Abe", email: "abc@abc.com", password: "abcde",
