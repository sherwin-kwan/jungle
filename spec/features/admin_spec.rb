...
RSpec.describe "Admins", type: :feature, js: true do
  # SETUP SEEDS
  before do
    load "#{Rails.root}/db/seeds.rb"
  end

  it "Admin pages should be inaccessible without authentication" do
    visit root_path
    click_on "Admin"
    save_screenshot
    click_on "Dashboard"
  ...
  it "Admin pages can be accessed with authentication" do
    visit root_path
  ...
  it "Admins can create new categories, and create new products with those categories" do
    visit root_path
    page.driver.basic_authorize(ENV["ADMIN_USERNAME"], ENV["ADMIN_PASSWORD"])
    click_on "Admin"
